...
public class Bank {
    ...
    public void openAccount(String accountid) throws AccountExistsException {
        if (accountlist.containsKey(accountid)) {
            ...
            // Błąd był tutaj nie było implementacji otwierania nowego konta i dodawania go do listy
...
//        if (accountlist.containsKey(accountid)) {
//        Błąd był tutaj nie było ! przed accountlist.containsKey(accountid)
        if (!accountlist.containsKey(accountid)) {
    ...
    public void withdraw(String accountid, Money money) throws AccountDoesNotExistException {
        if (!accountlist.containsKey(accountid)) {
            ...
            Account account = accountlist.get(accountid);
//            account.deposit(money);
//            Błąd był tutaj było deposit zamiast withdraw
...
//        Błąd był tutaj było 2 razy fromaccount zamiast toaccount
