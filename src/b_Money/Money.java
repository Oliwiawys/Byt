...
public class Money implements Comparable {
    ...
    public String toString() {
        return String.format("%d.%02d %s", this.amount / 100, this.amount % 100, this.currency.getName());
    }
    ...
    public Money add(Money other) {
        int otherInThisCurrency = this.currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
